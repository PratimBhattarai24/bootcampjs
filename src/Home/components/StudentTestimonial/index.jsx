  ...
  return (
    <div className="container  py-14 mb-14">
      <div className="w-full h-screen">
        <h1 className="text-4xl font-bold flex justify-center my-8">
        ...
        <div className="flex flex-col lg:grid lg:gap-4 2xl:gap-6 lg:grid-cols-4 2xl:row-span-2 2xl:pb-8 ml-2 pt-4 px-6">
          ...
          <div className="bg-darkyellow lg:order-2 lg:row-span-4 lg:col-span-1 rounded-lg shadow-xl mb-5 lg:pb-4 2xl:h-screen">
